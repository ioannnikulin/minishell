...
/*   Updated: 2024/12/15 20:48:57 by inikulin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	do_pipe(t_executor *e)
{
	int	p[2];
...
static int	tofile(t_executor *e, char *fname, int append)
{
...
int	set_redirs(t_executor *e)
{
	...
	if (ft_strcmp(e->node->sibling_next->content, "|") == 0)
		...
		return (tofile(e, e->node->sibling_next->sibling_next->content,
